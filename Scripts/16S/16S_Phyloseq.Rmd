...
bb16S_bac_ML_B_merged<-prune_taxa(taxa_sums(bb16S_bac_ML_B_merged) < 1, bb16S_bac_ML_B_merged)
...
plot_tree(baruta_Site_indicators_ps_object_A, color="Site", label.tips = "taxa_names")

plot_tree(baruta_Site_indicators_ps_object_B, color="Site", label.tips = "taxa_names")
```
