...
plot_tree(core_genus, color = "Site", shape = "Timepoint")
plot_tree(core_asv, color = "Site", shape = "Timepoint")
#plot bars for exploratory purposes. Many unknowns at genus level and family level
plot_bar(core_genus, x = "Region_Site", fill = "Family") + scale_fill_manual(values = col_vector) +geom_bar(stat="identity")
plot_bar(core_asv, x = "Region_Site", fill = "Family") + scale_fill_manual(values = col_vector) +geom_bar(stat="identity")
...
```
Shared and unique taxa among sites by phylogney
```{r}
...
#condense by tips and taxonomy
bb16S_bac_rarefy_tip_merged<-tip_glom(physeq = bb16S_bac_rarefy, h = 0.2)

bb16S_bac_rarefy_tax_merged<-tax_glom(physeq = bb16S_bac_rarefy, taxrank = "Genus")
bb16S_bac_rarefy_tax_merged_F<-tax_glom(physeq = bb16S_bac_rarefy, taxrank = "Genus", NArm = F)

common_taxa(phyloseq_obj = bb16S_bac_rarefy_tax_merged_F, treatment = "Site", n = 'all')
common_taxa(phyloseq_obj = bb16S_bac_rarefy, treatment = "Site", n = 'all')



taxa_core_graph(phyloseq_obj = bb16S_bac_rarefy, treatment = "Site")

#group at genus and re run.
bb16S_bac_rarefy_tip_merged<-tip_glom(physeq = bb16S_bac_rarefy, h = 0.2)



unique_taxa(phyloseq_obj = bb16S_bac_rarefy_tip_merged, treatment = "Site")


tax_prop_out<-taxa_proportions(bb16S_bac_rarefy_tip_merged, 'Class', treatment = c('Site'))


ggplot(data = tax_prop_out, aes(Site, Proportion, fill = Class)) +
   geom_bar(stat='identity')

unique_taxa(phyloseq_obj = bb16S_bac_rarefy_tip_merged, treatment = "Region")
unique_taxa(phyloseq_obj = bb16S_bac_rarefy_tip_merged, treatment = "Treatment")

common_taxa(phyloseq_obj = bb16S_bac_rarefy, treatment = "Site", n = "all")
common_taxa(phyloseq_obj = bb16S_bac_rarefy, treatment = "Site")
