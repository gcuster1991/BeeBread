...
plot_tree(core_genus, color = "Site", shape = "Timepoint", label.tips = "Order")
plot_tree(core_asv, color = "Site", shape = "Timepoint", label.tips = "Order" )
...
unique_genera_to_region_tax<-unique_taxa(phyloseq_obj = bb16S_bac_rarefy_tax_genus, treatment = "Region", below = 3)
