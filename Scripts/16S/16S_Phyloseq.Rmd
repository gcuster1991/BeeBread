...
Examine taxa driving differences among treatments post application
```{r}

#post-treatment samples
bb16S_bac_ML_B <- subset_samples(bb16S_bac_ML, Timepoint == "B")
baruta_Site_indicators_B<-baruta_phyloseq(physeq = bb16S_bac_ML_B, GroupingVar = "Treatment")
baruta_Site_indicators_ps_object_B <- subset_taxa(bb16S_bac_ML_B, taxa_names(bb16S_bac_ML_B) %in% baruta_Site_indicators_B)
...
```{r}
plot_tree(baruta_Site_indicators_ps_object, color="Genus", shape = "Timepoint", size = "abundance", label.tips = "taxa_names")
```
