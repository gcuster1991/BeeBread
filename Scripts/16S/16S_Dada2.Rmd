...
```{r}
#path_dm <- ("/Volumes/GoogleDrive/Other computers/Office_iMac/Quick_Sync/Lopez_Uribe/16S/16S_reads/demultiplexed/")
...
create phylogenetic tree with phangorn defaults
```{r}
