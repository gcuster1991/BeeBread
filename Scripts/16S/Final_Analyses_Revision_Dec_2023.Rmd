...
sample_sums(bb16S_bac_rarefy_iter)
...
#extract colors for future plots.
testBuild<-ggplot_build(plot = sf2d)
unique(testBuild$data[[1]]["colour"])
...
richness_BB16S_bac$Timepoint <- as.factor(values[match(richness_BB16S_bac$Timepoint, index)])

richness_BB16S_bac$Timepoint <- factor(richness_BB16S_bac$Timepoint, levels = c("Before", "After"), ordered = T)

shannon<-ggplot(data = richness_BB16S_bac) + geom_boxplot(aes(x = Timepoint, y = Shannon, fill = Treatment)) + theme_classic() + ggtitle("Shannon Diversity") + theme(plot.title = element_text(hjust = 0.5)) + theme(legend.position="none") + theme(axis.text=element_text(size=12, angle = 45, hjust =0.75), axis.title=element_text(size=14))

chao<-ggplot(data = richness_BB16S_bac) + geom_boxplot(aes(x = Timepoint, y = Chao1, fill = Treatment)) + theme_classic() + ggtitle("Chao1") + theme(plot.title = element_text(hjust = 0.5)) + theme(legend.position="none")+ theme(axis.text=element_text(size=12, angle = 45, hjust =0.75), axis.title=element_text(size=14))

observed<-ggplot(data = richness_BB16S_bac) + geom_boxplot(aes(x = Timepoint, y = Observed, fill = Treatment)) + theme_classic() + ggtitle("Richness") + theme(plot.title = element_text(hjust = 0.5)) +theme(legend.position="none") +  theme(axis.text=element_text(size=12, angle = 45, hjust =0.75), axis.title=element_text(size=14))

observed_legend<-ggplot(data = richness_BB16S_bac) + geom_boxplot(aes(x = Timepoint, y = Observed, fill = Treatment)) + theme_classic() + ggtitle("Richness") + theme(plot.title = element_text(hjust = 0.5)) +  theme(axis.text=element_text(size=12, angle = 45, hjust =0.75), axis.title=element_text(size=14))

#t<-arrangeGrob(shannon, chao, observed, ncol =3)
#plot(t)
#ggsave("/Users/gordoncuster/Desktop/Git_projects/BeeBread/Writing/Final_Figs/December2023/alphadiv.eps")
 
#setEPS()
#postscript("/Users/gordoncuster/Desktop/Git_projects/BeeBread/Writing/Final_Figs/December2023/alphadiv.eps")
#plot(t)
#dev.off()


#legend <- cowplot::get_legend(observed_legend)

#grid.newpage()
#grid.draw(legend)

#setEPS()
#postscript("/Users/gordoncuster/Desktop/Git_projects/BeeBread/Writing/Final_Figs/December2023/alphadiv_legend.eps")
#plot(legend)
#dev.off()
...
library(emmeans)
emmeans(mod, list(pairwise ~ Treatment * Timepoint), adjust = "tukey")
```
...
#gsave("../../Writing/Final_Figs/December2023/taxabarAfter_12_25_23.eps")
...
ggsave("/Users/gordoncuster/Desktop/Git_Projects/BeeBread/Writing/Final_Figs/OTU_122_After_Treatment.eps")
