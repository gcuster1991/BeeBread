...
plot_heatmap(core_genus, sample.order = "Timepoint", low = "#F0E442", high = "#D55E00", na.value = "White") + theme (axis.text.x = element_text(size=7))
...
ggsave("../../Writing/Final_Figs/December2023/venn_treatment.eps")

ps_venn(bb16S_bac_rarefy_iter, group = "Timepoint", fraction = 0.01, weight = F, plot = T)
ggsave("../../Writing/Final_Figs/December2023/venn_timepoint.eps")
