...
plot_heatmap(core_genus, sample.order = "Timepoint", low = "#F0E442", high = "#D55E00", na.value = "White", taxa.order = c("OTU_33", "OTU_9", "OTU_8", "OTU_18", "OTU_35", "OTU_55", "OTU_62", "OTU_97", "OTU_5","OTU_99","OTU_117", "OTU_37", "OTU_40",  "OTU_82","OTU_103")) + theme (axis.text.x = element_text(size=7))

ggsave("../../Writing/Final_Figs/December2023/heatmap_core_genus.eps")
