...
kruskal.test(Shannon ~ interaction(Treatment, Site, Timepoint),  data = richness_BB16S_bac)
kruskal.test(Shannon ~ Timepoint,  data = richness_BB16S_bac)
...
#signifcant Levene's test for Site. We will run an additional Kruskal Wallis for site. 
kruskal.test(Shannon ~ Site, data = richness_BB16S_bac)
...
#extract sequence of core genera. 
